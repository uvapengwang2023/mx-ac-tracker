...
function buildAutomationMatrix() {
  return [
    ...
    {
      area: "竞品名单分层",
      aiRole: "在产品系列整理完成后，先按核心规格硬门槛过滤，再提出候选直接竞品和标杆竞品。",
      autoUpdate: "中",
      humanRole: "先确认品牌系列、系列价格阶梯和硬门槛，再确认谁是真正竞品。",
...
function buildExecutionChecklist() {
  return [
    ...
    },
    {
      ...
      priority: "P0",
      title: "竞品池自动分层",
      objective: "以 Prime SKU 为目标池，在产品系列整理完成后，把商品分成直接竞品、强候选、价格/规格参照、内部参照和观察项。",
      dataNeeded: "标准规格字段、产品系列、系列价格阶梯、价格、平台、品牌、商品链接、你指定的目标 SKU",
      aiAutomation: "正式重启时先按硬门槛过滤：产品类型、制冷能力、单冷/冷暖、电压、变频/定频；再用价格、品牌、系列和平台排序解释。",
      output: "data/competitor_candidates/latest_competitor_candidates.json/csv + SQLite competitor_candidates 表",
      acceptance: "只有硬门槛相同或明确等价的商品才进入横向对比；每个候选必须保留可比原因和风险。",
      humanGate: "先完成 A02 产品系列和系列价格阶梯整理，再确认哪些是真竞品、弱竞品或不可比。",
      status: "技术原型，等待 A02 系列整理",
  ...
  const data = {
    ...
    methodology: {
      ...
      fieldNotes: [
        ...
        "竞品池候选来自标准字段的规则打分；当前仅作为 A03 技术原型，不是最终竞品名单，正式使用前必须先完成 A02 产品系列整理。",
        "A03 正式重启时必须先满足硬门槛：产品类型、制冷能力、单冷/冷暖、电压、变频/定频相同或明确等价。",
